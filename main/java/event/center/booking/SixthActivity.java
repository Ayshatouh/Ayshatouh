...
import android.widget.ScrollView;
 ...
 public class SixthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        down_arrow2=findViewById(R.id.down_arrow2);
        sixth_scrollview=findViewById(R.id.sixth_scrollview);

        from_bottom= AnimationUtils.loadAnimation(this, R.anim.anim_from_bottom);
        down_arrow2.setAnimation(from_bottom);
        ...
        down_arrow2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                pairs[0] = new Pair<View, String>(down_arrow2, "activity_fourth");
